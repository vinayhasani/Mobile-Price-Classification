...
model <- nnet::multinom(price_range ~ram+battery_power+px_height+px_width+mobile_wt+dual_sim+int_memory, tr_data)
...
plot(s1,col="red", main="ROC Curve With Stepwise Selection")
